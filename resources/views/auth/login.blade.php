...
<body class="bg-[#fff6da] flex items-center justify-center min-h-screen">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden flex max-w-6xl w-full my-8">
        <!-- Kiri -->
        <div
            class="w-1/2 bg-gradient-to-b from-[#ffe6bf] to-[#ffb64f] p-10 flex flex-col items-center justify-center space-y-6">
            <img src="{{ asset('image/turuu.png') }}" alt="Sweet Cake" class="w-72" />
            ...
            <form id="login-form" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="remember" id="remember"
                        class="h-4 w-4 text-[#af5100] border-gray-300 rounded focus:ring-[#683100]">
